// Hero 4 - Updated February 12, 2025
function noop() { }
function run(fn) {
    return fn();
}
...
// (50:8) {#each event.videos as video}
function create_each_block_1(ctx) {
	...
	return {
		...
		h() {
			...
			if (!src_url_equal(iframe.src, iframe_src_value = embedURL(/*video*/ ctx[6].video_url))) attr(iframe, "src", iframe_src_value);
			...
			attr(iframe, "referrerpolicy", "strict-origin-when-cross-origin");
...
function create_each_block(ctx) {
	let h2;
	let t0_value = /*event*/ ctx[3].name + "";
	let t0;
	let t1;
	let div;
	let t2;
	let each_value_1 = /*event*/ ctx[3].videos;
	let each_blocks = [];
	...
	return {
		...
		h() {
			attr(h2, "class", "event-name svelte-dbfvah");
			attr(div, "class", "video-grid svelte-dbfvah");
		},
		m(target, anchor) {
...
function create_fragment(ctx) {
	...
	return {
		...
		h() {
			attr(h1, "class", "headline svelte-dbfvah");
			attr(section0, "class", "section-container svelte-dbfvah");
			attr(section1, "class", "section-container svelte-dbfvah");
		},
		m(target, anchor) {
			insert_hydration(target, section0, anchor);
			append_hydration(section0, h1);
