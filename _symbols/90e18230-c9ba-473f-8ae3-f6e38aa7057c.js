// Site Header - Updated February 12, 2025
function noop() { }
const identity = x => x;
...
function create_each_block_1(ctx) {
	...
	return {
		...
		h() {
			attr(a, "class", "link svelte-7mdm6v");
...
function create_if_block_2(ctx) {
	...
	return {
		...
		h() {
			...
			attr(button, "class", "svelte-7mdm6v");
			attr(nav, "id", "popup");
			attr(nav, "class", "svelte-7mdm6v");
		},
		m(target, anchor) {
...
function create_fragment(ctx) {
	...
	let if_block0 = /*mobileNavOpen*/ ctx[4] && create_if_block_2(ctx);
	...
	return {
		...
		l(nodes) {
			...
			div2 = claim_element(header_nodes, "DIV", { id: true, class: true });
			...
			div3 = claim_element(header_nodes, "DIV", { id: true, class: true });
			...
			t4 = claim_text(h1_nodes, /*headline*/ ctx[1]);
		...
		h() {
			attr(nav, "class", "svelte-7mdm6v");
			attr(div0, "class", "desktop-nav svelte-7mdm6v");
			attr(button, "id", "open");
			attr(button, "aria-label", "Open mobile navigation");
			attr(div1, "class", "mobile-nav svelte-7mdm6v");
			attr(div2, "id", "top-nav");
			attr(div2, "class", "section-container svelte-7mdm6v");
			attr(a, "href", "/");
			attr(a, "class", "logo svelte-7mdm6v");
			attr(h1, "class", "headline svelte-7mdm6v");
			attr(div3, "id", "headline");
			attr(div3, "class", "section-container svelte-7mdm6v");
			...
			attr(header, "class", "svelte-7mdm6v");
		},
		m(target, anchor) {
		...
		p(ctx, [dirty]) {
			...
			if (!current || dirty & /*headline*/ 2) set_data(t4, /*headline*/ ctx[1]);
